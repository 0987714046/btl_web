...
<nav class="row flex-row">
    ...
    <div data-bs-spy="scroll" data-bs-target="#list-example" data-bs-offset="0" class="scrollspy-example col-9" tabindex="0">
        <div class="nav-collapse collapse show" id="collapseExample1 ">
            ...
            <div>
                <button type="button" style="background-color: #00a651;border-radius: 7px;"><a href="adduser.php" style="color: white;"><i class="fa fa-plus"></i> Thêm tài
                        khoản </a></button>
        ...
        <div class="nav-collapse collapse show" id="collapseExample2">
            ...
            <div>
                <button type="button" style="background-color: #00a651;border-radius: 7px;"><a href="addcourse.php" style="color: white;"><i class="fa fa-plus"></i> Thêm
                        khóa học </a></button>
        ...
        <div class="nav-collapse collapse" id="collapseExample3">
            ...
            <div>
                <button type="button" style="background-color: #00a651;border-radius: 7px;"><a href="addnews.php" style="color: white;"><i class="fa fa-plus"></i> Thêm tin tức </a> </button>
